      ...
      <div className="mx-auto max-w-[1200px] px-6 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 font-sans text-sm font-light leading-relaxed text-slate-300">
            ...
            <div className="flex gap-4">
              <a
                href="https://facebook.com/sanpatricfoodservice"
                target="_blank"
              ...
              <a
                href="https://instagram.com/sanpatricfoodservice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 transition-colors hover:text-brand-500"
              ...
              <a
                href="https://linkedin.com/company/sanpatricfoodservice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 transition-colors hover:text-brand-500"
                aria-label="LinkedIn"
